...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 -o Makefile Shannon-Fano-Kodierung.pro
#############################################################################
...
Makefile: Shannon-Fano-Kodierung.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 -o Makefile Shannon-Fano-Kodierung.pro
...
dist: 
	@test -d .tmp/Shannon-Fano-Kodierung1.0.0 || mkdir -p .tmp/Shannon-Fano-Kodierung1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Shannon-Fano-Kodierung1.0.0/ && $(COPY_FILE) --parents mainwindow.h sfcodec.h symbol.h sflist.h sftreenode.h .tmp/Shannon-Fano-Kodierung1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sfcodec.cpp symbol.cpp sflist.cpp sftreenode.cpp .tmp/Shannon-Fano-Kodierung1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Shannon-Fano-Kodierung1.0.0/ && (cd `dirname .tmp/Shannon-Fano-Kodierung1.0.0` && $(TAR) Shannon-Fano-Kodierung1.0.0.tar Shannon-Fano-Kodierung1.0.0 && $(COMPRESS) Shannon-Fano-Kodierung1.0.0.tar) && $(MOVE) `dirname .tmp/Shannon-Fano-Kodierung1.0.0`/Shannon-Fano-Kodierung1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Shannon-Fano-Kodierung1.0.0
